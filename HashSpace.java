...
//            if (n.id.compareTo(first.id) == -1) {
            if (n.id.compareTo(first.id) < 0) {
                if(first == last) {
//                    first.Successor = n.id;
//                    first.successor_port = n.port;
//                    first.Predecessor = n.id;
//                    first.predecessor_port = n.port;
//                    n.Predecessor = first.id;
//                    n.predecessor_port = first.port;
//                    n.Successor = first.id;
//                    n.successor_port = first.port;
                    first.Successor = n;
                    first.Predecessor = n;
                    n.Successor = first;
                    n.Predecessor = first;
...
//            else if(n.id.compareTo(last.id) == 1) {
                ...
                Node temp1 = null;
                Node temp2 = first;
//                while(temp2.id.compareTo(n.id) == -1){
...
//        result[0] = n.Predecessor.toString();
//        result[1] = n.predecessor_port;
    ...
    String[] getSuccessor_details(Node n){
        String result[] = new String[2];
//        result[0] = n.Successor.toString();
//        result[1] = n.successor_port;
